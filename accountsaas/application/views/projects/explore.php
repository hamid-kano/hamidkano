<div class="content-body">
            ...
            <p><?php
                ...
                ?>         <hr> <?php echo '<span class="p-1 text-bold-300">' . $this->lang->line('Clock') . ':</span>';
                                if (!isset($clock['key3'])) {
                                      ...
                                      echo '<span class="badge badge-danger">' . $this->lang->line('Off') . '</span><a href="' . base_url() . '/projects/clock_in?id='.$project['id'].'&ref='.$project['hash_code'].'" class="btn btn-outline-success  btn-outline-white btn-md ml-1 mr-1" ><span class="icon-toggle-on" aria-hidden="true"></span> ' . $this->lang->line('Clock') . ' ' . $this->lang->line('In') . ' <i
                                    class="ficon icon-clock "></i></a>';
                                } else {
                                           echo '<span class="badge badge-success">' . $this->lang->line('On') . '</span> <a href="' . base_url() . '/projects/clock_out?id='.$project['id'].'&ref='.$project['hash_code'].'" class="btn btn-outline-danger  btn-outline-white btn-md ml-1 mr-1" ><span class="icon-toggle-off" aria-hidden="true"></span> ' . $this->lang->line('Clock') . ' ' . $this->lang->line('Out') . ' <i
    ...
    <input type="hidden" id="dashurl" value="projects/task_stats?id=<?php echo $project['id'].'&ref='.$project['hash_code']; ?>">
    <div class="card">
        <div class="card-body">
                ...
                <div class="tab-content px-1 pt-1">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td style="direction: ltr;">
                                        <a href="<?php echo base_url('customers/view?id='.$project['cid'].'&ref='.$project['hash_code']) ?>" target="_blank"><?php echo $project['customer'] ?></a> <br>
                                        <a href="mailto:<?php echo $project['email'] ?>"><?php echo $project['email'] ?></a><br>
                                        <a href="tel:<?php echo $project['phone'] ?>"><?php echo $project['phone'] ?></a>
                                    </td>
                    ...
                    <div class="tab-pane fade" id="link" role="tabpanel" aria-labelledby="link-tab"
                         aria-expanded="false"><p><a
                                    href="<?php echo base_url('projects/addtask?id=' . $project['id'].'&ref='.$project['hash_code']) ?>"
                    ...
                    <div class="tab-pane fade" id="milestones" role="tabpanel"
                        ...
                        <p><a href="<?php echo base_url('projects/addmilestone?id=' . $project['id'].'&ref='.$project['hash_code']) ?>"
                              class="btn btn-primary btn-sm rounded">
                    ...
                    <div class="tab-pane fade" id="activities" role="tabpanel"
                         aria-labelledby="activities-tab" aria-expanded="false" style="direction: ltr;"><p><a
                                    href="<?php echo base_url('projects/addactivity?id=' . $project['id'].'&ref='.$project['hash_code']) ?>"
                                    class="btn btn-primary btn-sm rounded">
                                ...
                                <section class="row">
                                    ...
                                    <div data-block="sec" class="col">
                                        <div class=""><?php
                                            ...
                                            echo '<a class="" href="' . base_url('userfiles/project/' . $row['value']) . '">' . ($row['key3'] ?? $row['value']) . '</a> &nbsp; &nbsp; <a href="#" class=" danger delete-custom" data-did="1" data-object-id="' . $row['meta_data'] . '"><i class="fa fa-trash"></i></a> ';
                                            echo '<br>';
        ...
        <label><?php echo $this->lang->line('File Name'); ?></label>
        ...
        <input id="fileupload" type="file" name="files[]">
                    ...
                    <div class="tab-pane fade" id="invoices" role="tabpanel" aria-labelledby="invoices-tab"
                         aria-expanded="false">
                        <p><a href="<?php echo base_url('invoices/create?project=' . $project['id'].'&ref='.$project['hash_code']) ?>"
                              class="btn btn-primary btn-sm rounded">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-1">
                                ...
                                foreach ($invoices as $item) {
                                    echo '<tr>
                                <td class="text-truncate"><a href="' . base_url() . 'invoices/view?id=' . $item['id'] . '&ref='.$item['hash_code'].'">#' . $item['tid'] . '</a></td>
                    ...
                    <div class="tab-pane fade" id="tickets" role="tabpanel" aria-labelledby="tickets-tab"
                         aria-expanded="false">
                        <a class="btn btn-primary mb-3" href="<?= base_url().'tickets/create' ?>"><?php echo $this->lang->line('Add') ?></a>
                        <div class="table-responsive">
                            <table class="table table-hover mb-1">
                                <thead>
                                <tr>
                                ...
                                foreach ($tickets as $ticket) {
                                    ...
                                    <td>'.dateformat_time($ticket['created']).'</td>
                                    <td><span class="st-' . $ticket['status'] . '">' . $this->lang->line($ticket['status']) . '</span></td>
                                <td><a href="' . base_url('tickets/thread/?id=' . $ticket['id']) . '" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> ' . $this->lang->line('View') . '</a></td>
                            </tr>';
                                } 
                                    
                                } else {
                                    echo '<tr><td class="text-center" colspan="5">'.$this->lang->line("No Data Found").'</td></tr>';
                                }
                                ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <input type="hidden" name="project_id" value="<?php echo $project['id']; ?>">
                     <input type="hidden" name="ref" value="<?php echo $project['hash_code']; ?>">
        ...
        $('#todotable').DataTable({
            ...
            "ajax": {
                ...
                data: {
                    ...
                    'ref_project':'<?php echo $project['hash_code']; ?>',
...
<script>
    ...
    $(function () {
        ...
        var url = baseurl + 'projects/file_handling?id=<?php echo $project['id'].'&ref_id="'.$project['hash_code'].'"'; ?>',
            uploadButton = $('<button/>')
                ...
                var filename = document.querySelector("#file_name").value;
  ...
  data.formData = {'<?=$this->security->get_csrf_token_name()?>': crsf_hash,"file_name" : filename.value};
});;
