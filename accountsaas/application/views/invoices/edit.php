                            ...
                            <div class="col-sm-6 cmp-pnl">
                                <div class="inner-cmp-pnl">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col"><label for="invociedate"
                                        ...
                                        <div class="col"><label for="invocieduedate" class="caption"><?php echo $this->lang->line('Invoice Due Date') ?></label>
                                        ...
                                        <div class="col"><label for="invociebookingdate" class="caption"><?php echo $this->lang->line('Booking Date') ?></label>

                                            <div class="input-group">
                                                <div class="input-group-addon"><span class="icon-calendar-o" aria-hidden="true"></span></div>
                                                <input type="text" class="form-control round required editdate"
                                                       name="invociebookingdate"
                                                       placeholder="<?php echo $this->lang->line('Booking Date') ?>" autocomplete="false"
                                                       value="<?php echo dateformat($invoice['invociebookingdate']) ?>">
                                            </div>
                                        </div>
                                        <?php } ?>
                                    </div>
                             ...
                             <input type="hidden" name="unit[]" id="unit-' . $i . '" value="' . $row['unit'] . '">
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    <td colspan="2"><?php echo $this->lang->line('Payment Terms') ?> <select
                                        ...
                                        <br>
                                        <textarea class="summernote" name="text_terms"><?php echo $invoice['text_terms']; ?></textarea>
                                        </td>
