<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('Manage Invoices') ?> <a href="<?php echo base_url('invoices/create') ?>" class="btn btn-primary btn-sm rounded">
                ...
                <table id="invoices" class="table table-striped table-bordered zero-configuration ">
                    <thead>
                        <tr>
                            ...
                            <?php }else{ ?>
                                <th><?php echo $this->lang->line('Invoice Due Date') ?></th>
                            <?php }?>
