<style>.tfr td {min-width: 100px;}</style>
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="post" id="data_form">
                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div class="inner-cmp-pnl">
                                    ...
                                    <div class="col-sm-6"><label for="invocieno"
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control round" placeholder="Invoice #"
                                                   name="invocieno1"
                                                   value="<?php echo $lastinvoice + 1 ?>" disabled="true">
                                        </div>
                                    </div>
                                    <div class="col-sm-6"><label for="invocieno"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <label for="invocieduedate" class="caption">
                                            <?php echo $this->lang->line('Invoice Due Date') ?>
                                        </label>

                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-calendar-o" aria-hidden="true"></span></div>
                                            <input type="text" class="form-control round required" id="tsn_due" name="invocieduedate" placeholder="Due Date" data-toggle="datepicker" autocomplete="false">
                                        </div>
                                    </div>
                                <?php if($is_booking_state_activated){ ?>    
                                    <div class="col">
                                        <label for="invociebookingdate" class="caption">
                                            <?php echo $this->lang->line('Booking Date') ?>
                                        </label>

                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-calendar-o" aria-hidden="true"></span></div>
                                            <?php if (isset( $_GET['booking_date']) and  $_GET['booking_date']){?>
                                                <b><?=$_GET['booking_date']?></b>
                                                <input name="invociebookingdate" type="hidden" value="<?=$_GET['booking_date']?>">
                                            <?php }else{ ?>
                                            <input type="text" class="form-control round required" id="tsn_booking" name="invociebookingdate" placeholder="<?php echo $this->lang->line('Booking Date') ?>" data-toggle="datepicker" autocomplete="false">
                                            <?php } ?>
                                        </div>
                                    </div>
                                <?php } ?>
                        ...
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="2"><?php echo $this->lang->line('Payment Terms') ?> <select name="pterms"
                                                                                                         class="selectpicker form-control">
                                    <option value=""><?php echo $this->lang->line('Custom terms');  ?></option>
                                                                                                         <?php foreach ($terms as $row) {
                                            echo '<option value="' . $row['id'] . '">' . $row['title'] . '</option>';
                                        } ?>
                                    </select>
                                    <br>
                                        <?php echo $this->lang->line('Custom Payment Terms') ?> 
                                        <br>
                                        <textarea class="summernote" name="text_terms"></textarea>
                                    </td>
                                <td class="reverse_align" colspan="4"><input type="submit"
                    ...
                    <input type="hidden" name="invocieno" value="<?php echo $lastinvoice + 1 ?>">
...
<script>
    ...
    <?php if($_SERVER['HTTP_HOST']=="hanan.almusand.co" || $_SERVER['HTTP_HOST']=="deem11.almusand.co" ){?> $("input[name='invoicedate']").prop('disabled', false);<?php } ?>       
    });
</script>
