            ...
            <div id="invoice-template" class="card-body">
                <div class="row wrapper white-bg page-heading">
                    ...
                    <div class="col-lg-12">
                        ...
                        $link = base_url('billing/stockreturn?id=' . $invoice['iid'] . '&token=' . $validtoken.'&ref='.$ref);
                        if ($invoice['status'] != 'canceled') { ?>
                            ...
                            switch ($invoice['i_class']) {
                                case 0 :
                                    $eurl = 'edit?id=' . $invoice['iid']. '&ref=' . $ref;
                                    $type_i = $this->lang->line('Stock Return');
                                    $purl = base_url() . 'billing/printstockreturn?id=' . $invoice['iid'] . '&ty=0&token=' . $validtoken. '&ref=' . $ref;
                                    $curl = base_url('supplier/view?id=' . $invoice['cid']. '&ref=' . $ref);
                                    break;
                                case 1 :
                                    $eurl = 'edit_c?id=' . $invoice['iid'].'&ref='.$ref;
                                    $type_i = $this->lang->line('Stock Return') . ' ' . $this->lang->line('Customer');
                                    $purl = base_url() . 'billing/printstockreturn?id=' . $invoice['iid'] . '&ty=1&token=' . $validtoken. '&ref=' . $invoice['hash_code'];
                                    $curl = base_url('customers/view?id=' . $invoice['cid']. '&ref=' . $ref);
                                    break;
                                case 2 :
                                    $eurl = 'edit_note?id=' . $invoice['iid'] .'&ref=' . $ref;
                                    $type_i = $this->lang->line('Credit Note');
                                    $purl = base_url() . 'billing/printstockreturn?id=' . $invoice['iid'] . '&ty=2&token=' . $validtoken. '&ref=' . $ref;
                                    $curl = base_url('customers/view?id=' . $invoice['cid']. '&ref=' . $ref);
                                    break;
                            }
