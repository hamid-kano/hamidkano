            ...
            <div id="invoice-template" class="card-body">
                ...
                <div id="invoice-customer-details" class="row pt-2">
                    ...
                    <div class="offset-md-3 col-md-3 col-sm-12 text-xs-center text-md-left">
                        <?php echo '<p><span class="text-muted">' . $this->lang->line('Invoice Date') . '  :</span> ' . dateformat($invoice['invoicedate']) . '<p><span class="text-muted">' . $this->lang->line('Time') . ' :</span> ' . $invoice['invoicetime'] . '</p> 
                        </p> <p><span class="text-muted">' . $this->lang->line('Due Date') . ' :</span> ' . dateformat($invoice['invoiceduedate']) . '</p> 
