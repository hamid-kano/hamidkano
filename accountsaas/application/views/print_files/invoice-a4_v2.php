...
<table id="items">
    ...
    foreach ($products as $row) {
        ...
        echo '	  <tr class="item-row">
		      ...
		      <td>' . amountExchange($row['price'] * $row['qty'], $invoice['multi'], $invoice['loc']) . '</td>
		  </tr>';
 ...
 <tr>
    ...
    <?php if ($invoice['tax'] > 0) {
        ...
        echo '<tr>
		      ...
		      <td class="total-value"><div id="total">' .  amountExchange($invoice['total']-$sub_t-$invoice['discount'], $invoice['multi'], $invoice['loc']) . '</div></td>
		  </tr>';
    }
        else{
    ...
    ?>
     <?php if ($invoice['tax'] > 0) {
        ...
        echo '<tr>
		      ...
		      <td colspan="2" class="blank"> </td>
		      <td colspan="2" class="total-line">' . $this->lang->line('Inc_tax') . '</td>
		      <td class="total-value"><div id="total">' .  amountExchange($invoice['tax'], $invoice['multi'], $invoice['loc']) . '</div></td>
		  </tr>';
