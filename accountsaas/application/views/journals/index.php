<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5><?php echo $this->lang->line('Journals') ?> <a
        ...
        <div class="card-body">
            ...
            <table id="trans_table" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                ...
                <tr>
                    ...
                    <th><?php echo $this->lang->line('sum journal') ?></th>
                    <th><?php echo $this->lang->line('Total Lines') ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#trans_table').DataTable({
            ...
            <?php datatable_lang();?>
            "ajax": {
                "url": "<?php echo site_url('journals/translist')?>",
                "type": "POST",
