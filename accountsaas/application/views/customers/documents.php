                    ...
                    <div class="col-md-4 border-right border-right-grey">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                </a> <a href="<?php echo base_url('customers/projects?id=' . $details['id'].'&ref='. $details['hash_code']) ?>"
                    ...
                    <div class="col-md-8">
                        ...
                        <h4 class="title">
                            <?php echo $this->lang->line('Documents') ?> <a
                                    href="<?php echo base_url('customers/adddocument?id=' . $id.'&ref='. $details['hash_code']) ?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" id="object-ref" value="">
        ...
        $(document).ready(function () {
            ...
            $('#doctable').DataTable({
                ...
                "ajax": {
                    ...
                    "type": "POST",
                    'data': {'cid':<?=$id ?>,'ref':<?=$ref ?>, '<?=$this->security->get_csrf_token_name()?>': crsf_hash}
                },
                "columnDefs": [
                    {
                        "targets": [0],
