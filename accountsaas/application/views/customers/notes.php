            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <hr>
                        <a href="<?php echo base_url('customers/addnote?id=' . $details['id'].'&ref='. $details['hash_code']) ?>"
        ...
        $(document).ready(function () {
            $('#notestable').DataTable({
                ...
                'ajax': {
                    ...
                    'type': 'POST',
                    'data': {'cid':<?php echo $_GET['id'] ?>,'ref':<?php echo $_GET['ref'] ?>, '<?=$this->security->get_csrf_token_name()?>': crsf_hash}
                },
                'columnDefs': [
                    {
                        'targets': [0],
