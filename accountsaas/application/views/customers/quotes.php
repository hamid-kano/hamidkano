                    ...
                    <form id="sendmail_form"><input type="hidden"
                        ...
                        <input type="hidden" class="form-control"
                               id="cid" name="tid" value="<?php echo $details['id'] ?>">
                                <input type="hidden" class="form-control"
                               id="tref_id" name="tref_id" value="<?php echo $details['hash_code'] ?>">
        ...
        $(document).ready(function () {
            $('#invoices').DataTable({
                ...
                'ajax': {
                    ...
                    'type': 'POST',
                    'data': {'cid':<?php echo $_GET['id'] ?>,'ref_id':<?php echo $_GET['ref'] ?>, '<?=$this->security->get_csrf_token_name()?>': crsf_hash}
                },
                'columnDefs': [
                    {
                        'targets': [0],
