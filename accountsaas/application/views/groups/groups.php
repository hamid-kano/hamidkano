        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <table id="cgrtable" class="table table-striped table-bordered zero-configuration">
                    ...
                    <td><a href='" . base_url("clientgroup/groupview?id=$cid&ref=$hash_code") . "' class='btn btn-success btn-xs'><i class='fa fa-eye'></i>  " . $this->lang->line('View') . "</a>&nbsp;<a href='" . base_url("clientgroup/editgroup?id=$cid&ref=$hash_code") . "' class='btn btn-warning btn-xs'><i class='fa fa-pencil'></i> " . $this->lang->line('Edit') . "</a>&nbsp;<a href='#' data-object-ref='" . $hash_code . "'  data-object-id='" . $cid . "'  class='btn btn-info btn-xs discount-object' title='Apply Discount'><i class='fa fa-bolt'></i> " . $this->lang->line('Discount') . "</a> <a href='#'  data-object-ref='" . $hash_code . "' data-object-id='" . $cid . "' class='btn btn-danger btn-xs delete-object' title='Delete'><i class='fa fa-trash'></i></a></td></tr>";
                        $i++;
                    }
                    ?>
                    </tbody>
