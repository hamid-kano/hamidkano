            ...
            <div id="invoice-template" class="card-body">
                <div class="row wrapper white-bg page-heading">
                    <div class="col-lg-12">
                        ...
                        $link = base_url('billing/quoteview?id=' . $invoice['iid'] . '&token=' . $validtoken.'ref='.$ref);
                        ?>
                        <div class="title-action">

                            <a href="<?php echo 'edit?id=' . $invoice['iid'].'&ref='.$ref; ?>" class="btn btn-warning mb-1"><i
                            ...
                            <div class="btn-group ">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item"
                                       href="<?= base_url('billing/printquote?id=' . $invoice['iid'] . '&token=' . $validtoken.'&ref='.$ref); ?>"><?php echo $this->lang->line('Print') ?></a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                                       href="<?= base_url('billing/printquote?id=' . $invoice['iid'] . '&token=' . $validtoken.'ref='.$ref); ?>&d=1"><?php echo $this->lang->line('PDF Download') ?></a>
                ...
                <form id="form_model2">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" class="form-control required"
                         ...
                         <input type="hidden" class="form-control required"
                               name="ref_convert" id="ref_convert" value="<?php echo $ref ?>">
...
<div id="pop_model3" class="modal fade">
   ...
   <div class="form-group row">
                    ...
                    <div class="modal-footer">
                     <input type="hidden" class="form-control required"
                               name="ref_convert_p" id="ref_convert_p" value="<?php echo $ref ?>">
