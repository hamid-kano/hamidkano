...
class Credit_notes extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('credit_notes_model', 'credit_notes');
    ...
    {
        $data['invoices'] = $this->plugins->universal_api(5);
...
// Your Account SID and Auth Token from twilio.com/console
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $invoices) {
            ...
            $row[] = '<a href="' . base_url("invoices/view?id=$invoices->id&ref=".$invoices->hash_code."") . '">&nbsp; ' . $invoices->tid . '</a>';
            $row[] = $invoices->name;
